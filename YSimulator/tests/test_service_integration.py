...
class TestServiceExposure:
    ...
    def test_server_uses_services(self):
        ...
        assert (
            len(found_services) >= 3
        ), f"Expected to find service classes in server.py, found: {found_services}"
...
class TestServiceUsagePatterns:
    ...
    def test_service_method_delegation(self):
        ...
        ), f"Expected to find service usage patterns, found: {found_patterns}"
    ...
    def test_reduced_direct_db_calls(self):
        ...
        service_call_count = (
            source_code.count("self.user_service")
...
class TestPhase5Completion:
    ...
    def test_coordination_layer_exists(self):
        ...
        assert os.path.exists(
            coordination_dir
        ), f"Coordination directory should exist at {coordination_dir}"
