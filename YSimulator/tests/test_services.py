...
class TestUserService:
    ...
    def test_add_user_interest(self, service, mock_interest_repo):
        ...
        assert result is True
        mock_interest_repo.add_user_interest.assert_called_once_with(
            user_id, interest_id, round_id
        )
...
class TestRecommendationService:
    ...
    def test_get_latest_agent_opinion(self, service, mock_interest_repo):
        ...
        mock_interest_repo.get_latest_agent_opinion.assert_called_once_with(
            agent_id, topic_id
        )
    ...
    def test_health_check_all_healthy(self, service, mock_rec_repo, mock_follow_repo, mock_interest_repo):
    ...
    def test_health_check_partial(self, service, mock_rec_repo, mock_follow_repo, mock_interest_repo):
