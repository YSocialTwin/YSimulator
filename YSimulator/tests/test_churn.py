...
def test_churn_config_in_all_examples():
    ...
    for config_file in config_files:
        ...
        assert (
            "inactivity_threshold" in churn_config
        ), f"Missing 'inactivity_threshold' in {config_file}"
...
def test_sqlalchemy_model_updates():
    ...
    assert (
        "last_active_day = Column" in models_content
    ), "Missing last_active_day column in User_mgmt model"
