...
class TestShareImplementation(unittest.TestCase):
    ...
    def test_02_comment_inherits_thread_id(self):
        ...
        print(
            f"✓ Comment {comment_id} has thread_id={comment['thread_id']} (inherited from parent)"
        )
    ...
    def test_06_nested_comments_inherit_root_thread_id(self):
        ...
        self.assertEqual(
            root_post["thread_id"], root_post_id, "Root post thread_id should equal post_id"
        )
        ...
        self.assertEqual(
            comment1["comment_to"], root_post_id, "First-level comment should reference root post"
        )
        ...
        self.assertEqual(
            comment2["comment_to"],
            comment1_id,
            "Second-level comment should reference first comment",
        )
