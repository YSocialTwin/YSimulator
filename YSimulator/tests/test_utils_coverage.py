...
class TestConfigurationValidation:
    ...
    def test_validate_config_directory_exists(self, test_data_dir):
        ...
        result = validate_config_directory(str(config_dir), required_files=["config.yml"])
    ...
    def test_validate_config_directory_not_exists(self):
        ...
        with pytest.raises(SystemExit):
            validate_config_directory("/non/existent/path", required_files=["config.yml"])
    ...
    def test_validate_config_directory_missing_file(self, test_data_dir):
        ...
        with pytest.raises(SystemExit):
            validate_config_directory(str(config_dir), required_files=["missing.yml"])
