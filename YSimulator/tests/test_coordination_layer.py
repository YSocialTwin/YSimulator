...
class TestClientManager:
    ...
    def test_register_client_new(self, client_manager):
        ...
        result = client_manager.register_client("client1", num_days=5, current_day=1, current_slot=1)
    ...
    def test_register_client_reregistration(self, client_manager):
        ...
        result = client_manager.register_client("client1", num_days=3, current_day=2, current_slot=3)
...
class TestRoundManager:
    ...
    def round_manager(self, mock_db, mock_interest_manager):
        ...
        return RoundManager(
            db_adapter=mock_db,
            interest_manager=mock_interest_manager,
            visibility_rounds=10
        )
    ...
    def test_advance_simulation_to_next_slot(self, round_manager, mock_db):
        ...
        result = round_manager.advance_simulation(
            recompute_interests_callback=None
        )
    ...
    def test_advance_simulation_to_next_day(self, round_manager, mock_db, mock_interest_manager):
        ...
        result = round_manager.advance_simulation(
            recompute_interests_callback=recompute_callback
        )
...
class TestArchetypeManager:
    ...
    def test_archetype_transition_logic(self, archetype_manager):
        ...
        possible_targets = list(archetype_manager.archetype_transitions.get(current_archetype, {}).keys())
    ...
    def test_transition_probabilities_invalid(self, mock_db):
        ...
        invalid_transitions = {
            "lurker": {
                "lurker": 0.5,
                "poster": 0.3,
                "commenter": 0.1  # Sum is 0.9, not 1.0
            }
        }
        manager = ArchetypeManager(
            db_adapter=mock_db,
            archetypes_enabled=True,
            archetype_transitions=invalid_transitions
        )
