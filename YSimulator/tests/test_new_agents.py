...
def test_new_agents_config_in_all_examples():
    ...
    for config_file in config_files:
        ...
        assert "enabled" in new_agents_config, f"Missing 'enabled' in new_agents config in {config_file}"
        assert "probability_new_agents" in new_agents_config, f"Missing 'probability_new_agents' in {config_file}"
