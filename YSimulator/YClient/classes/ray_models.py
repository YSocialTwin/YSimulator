...
class AgentProfile:
    ...
    recsys_type: str = "random"  # Content recommendation system mode:
    # random, rchrono, rchrono_popularity, rchrono_followers,
    # rchrono_followers_popularity, rchrono_comments, common_interests,
    # common_user_interests, similar_users_react, similar_users_posts
