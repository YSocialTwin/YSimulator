...
class NetworkLoader:
    ...
    def parse_network_edges(self, network_csv_path: Path, agent_profiles: List[AgentProfile]) -> List[Tuple[str, str]]:
        """
    ...
    def load_and_create_social_network(self, network_csv_path: Path, agent_profiles: List[AgentProfile], batch_size: int = 100) -> int:
        """
