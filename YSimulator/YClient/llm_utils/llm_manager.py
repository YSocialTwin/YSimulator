...
class LLMManager:
    ...
    def generate_news_post(
        self, cluster_id: int, agent_attrs: dict, article_title: str, article_summary: str
    ) -> Any:
        """
    ...
    def infer_article_opinion(
        ...
        return self.llm.infer_article_opinion.remote(article_content, topic_name, opinion_groups)
