...
from YSimulator.YServer.repositories.base_repository import InterestRepository, UserRepository
...
class UserService:
    ...
    def get_user_interests(self, user_id: str, start_round: int, end_round: int) -> List[str]:
        """
        ...
        try:
            return self.interest_repo.get_user_interests_in_window(user_id, start_round, end_round)
        except Exception as e:
