...
- **101 agents total**: **100 rule-based agents** and **1 news page**
...
- **100 Rule-based Agents**: Heuristic-based decision making
...
```bash
cd example/rule_population_100
...
python run_server.py --config example/rule_population_100/server_config.json
```
...
python run_client.py --config example/rule_population_100/simulation_config.json \
                     --agents example/rule_population_100/agent_population.json \
                     --prompts example/rule_population_100/prompts.json
```
