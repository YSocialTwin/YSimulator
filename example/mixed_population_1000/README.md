# Mixed Population 1000

This example demonstrates a YSimulator configuration with:
- **1001 agents total**: **500 LLM-enabled agents** and **500 rule-based agents** and **1 news page**
...
- **500 LLM Agents**: AI-powered decision making using language models
- **500 Rule-based Agents**: Heuristic-based decision making
...
```bash
cd example/mixed_population_1000
...
- **LLM requirements**: 500 LLM agents will make API calls to Ollama/OpenAI
