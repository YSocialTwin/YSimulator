#!/usr/bin/env python3
"""
Generate a population of 1000 agents (500 LLM, 500 rule-based) and 1 page agent
...
def generate_agent_population():
    """Generate 1000 agents and 1 page agent."""
    agents = []
    ...
    for i in range(1000):
        # First 500 are rule-based, next 500 are LLM
        is_llm = i >= 500
...
def main():
    ...
    print(f"  - 500 LLM-enabled agents")
    print(f"  - 500 rule-based agents")
