...
- **5001 agents total**: **5000 rule-based agents** and **1 news page**
...
```bash
cd example/rule_population_5000
...
python run_server.py --config example/rule_population_5000/server_config.json
```
...
python run_client.py --config example/rule_population_5000/simulation_config.json \
                     --agents example/rule_population_5000/agent_population.json \
                     --prompts example/rule_population_5000/prompts.json
```
