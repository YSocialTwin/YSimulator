#!/usr/bin/env python3
"""
Generate a population of 10000 agents (5000 LLM, 5000 rule-based) and 1 page agent
...
def generate_agent_population():
    ...
    for i in range(10000):
        # First 5000 are rule-based, next 5000 are LLM
        is_llm = i >= 5000
...
def main():
    ...
    print(f"  - 5000 LLM-enabled agents")
    print(f"  - 5000 rule-based agents")
