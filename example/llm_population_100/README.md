...
python run_server.py --config example/llm_population_100/server_config.json
```
...
python run_client.py --config example/llm_population_100/simulation_config.json \
                     --agents example/llm_population_100/agent_population.json \
                     --prompts example/llm_population_100/llm_prompts.json
```
