#!/usr/bin/env python3
"""
Generate a population of 100 agents (100 LLM, 0 rule-based) and 1 page agent
...
def generate_agent_population():
    """Generate 100 agents and 1 page agent."""
    agents = []
    ...
    # Generate 100 agents
    for i in range(100):
        # First 0 are rule-based, next 100 are LLM
        is_llm = i >= 0
...
def main():
    ...
    print(f"  - 100 LLM-enabled agents")
    print(f"  - 0 rule-based agents")
