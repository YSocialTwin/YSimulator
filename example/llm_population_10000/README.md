# Llm Population 10000

This example demonstrates a YSimulator configuration with:
- **10001 agents total**: **10000 LLM-enabled agents** and **1 news page**
...
- **10000 LLM Agents**: AI-powered decision making using language models
...
```bash
cd example/llm_population_10000
...
python run_server.py --config example/llm_population_10000/server_config.json
```
...
python run_client.py --config example/llm_population_10000/simulation_config.json \
                     --agents example/llm_population_10000/agent_population.json \
                     --prompts example/llm_population_10000/llm_prompts.json
```
...
- **LLM requirements**: 10000 LLM agents will make API calls to Ollama/OpenAI
