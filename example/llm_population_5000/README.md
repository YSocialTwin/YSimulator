...
- **5001 agents total**: **5000 LLM-enabled agents** and **1 news page**
...
```bash
cd example/llm_population_5000
...
python run_server.py --config example/llm_population_5000/server_config.json
```
...
python run_client.py --config example/llm_population_5000/simulation_config.json \
                     --agents example/llm_population_5000/agent_population.json \
                     --prompts example/llm_population_5000/llm_prompts.json
```
