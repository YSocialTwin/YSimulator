# Rule Population 10000

This example demonstrates a YSimulator configuration with:
- **10001 agents total**: **10000 rule-based agents** and **1 news page**
...
- **0 LLM Agents**: AI-powered decision making using language models
- **10000 Rule-based Agents**: Heuristic-based decision making
...
```bash
cd example/rule_population_10000
...
python run_server.py --config example/rule_population_10000/server_config.json
```
...
python run_client.py --config example/rule_population_10000/simulation_config.json \
                     --agents example/rule_population_10000/agent_population.json \
                     --prompts example/rule_population_10000/prompts.json
```
...
- **LLM requirements**: 0 LLM agents will make API calls to Ollama/OpenAI
