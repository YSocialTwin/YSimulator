#!/usr/bin/env python3
"""
Generate a population of 1000 LLM agents and 1 page agent
with an initial random social network (total: 1001 agents).
"""
...
def generate_agent_population():
    """Generate 1000 LLM agents and 1 page agent."""
    agents = []
...
def main():
    ...
    print(f"  - 1000 LLM-enabled agents")
    ...
    print("  - Discussion topics: war, politics, sport, books, movies")
    ...
    print("  - 1000 LLM-enabled agents + 1 page agent")
    print("  - Discussion topics: war, politics, sport, books, movies")
    print("  - Multiple recommendation strategies (content & follow)")
    print("  - Daily follow evaluation (10% probability)")
