#!/usr/bin/env python3
"""
Generate a population of 5000 agents (2500 LLM, 2500 rule-based) and 1 page agent
...
def generate_agent_population():
    ...
    for i in range(5000):
        # First 2500 are rule-based, next 2500 are LLM
        is_llm = i >= 2500
...
def main():
    ...
    print(f"  - 2500 LLM-enabled agents")
    print(f"  - 2500 rule-based agents")
