#!/usr/bin/env python3
"""
Generate a population of 1000 agents (0 LLM, 1000 rule-based) and 1 page agent
...
def generate_agent_population():
    ...
    for i in range(1000):
        # First 1000 are rule-based, next 0 are LLM
        is_llm = i >= 1000
...
def main():
    ...
    print(f"  - 0 LLM-enabled agents")
    print(f"  - 1000 rule-based agents")
